				...
				<div class="cs-table">
					<div class="cs-tablerow">
						<div class="pageinfo page-title-align-left">
							<h1 style="color:#fff !important; text-transform:none;">实名认证未通过</h1>
							<strong style="text-align:center; display:block; color:#fff; font-weight:normal;" class="title">很抱歉，您的实名认证未审批通过</strong>
						</div>
					</div>
				</div>
			</div>
									...
									<div class="col-lg-12">
										<div class="donate-area">
											<ul class="nav nav-tabs" role="tablist">
												<li class="active" role="presentation"><a >实名认证审批信息</a></li>
											</ul>
												...
												<div id="messages" class="tab-pane active fade in" role="tabpanel">
													<div class="confirmation-area">
														<div class="donate-holder">
															<div class="icon-area">
																<i class="icon-times" style="background-color:red;"></i>
															</div>
															<strong>您的实名认证申请未能通过审核， 原因</strong>
															<h3>${t.cause}</h3>
															<p>请根据以上原因，<a href="${APP_PATH}/member/cert-1.htm">修改申请信息</a></p>
														</div>
													</div>
												</div>
