									...
									<div class="col-lg-12">
										<div class="donate-area">
											<ul class="nav nav-tabs" role="tablist">
												...
												<li class="active" role="presentation"><a >03. 填写邮箱地址</a></li>
												<li role="presentation"><a >04. 提交申请成功</a></li>
											</ul>
											<div class="tab-content">
												<div id="home" class="tab-pane active fade in" role="tabpanel">
												    <form action="${APP_PATH}/member/uptEmail.htm?id=${member.id}&mtype=${mtype}" method="post" id="certForm">
													<div class="donate-holder">
														...
														<div class="cs-holder">
															<input type="submit" onclick="nextFlow();return false;" value="提交实名认证申请">
														</div>
													</div>
													</form>
												</div>
	        ...
	        success : function(r) {
	            if ( r.success ) {
	                setTimeout(function(){
	                    ...
	                    window.location.href = "${APP_PATH}/member/cert-4.htm?mtype=${mtype}";
	                }, 500);
	            }
	        },
	        error : function(r) {
