					...
					<div class="widget-body fuelux">
						<div class="step-content">
							...
							<form class="form-horizontal" id="permissionForm" method="post">
								<input type="hidden" name="icon" id="fclassval" value="${p.icon}">
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" id="fname" autocomplete="off" name="name" value="${p.name}" style="border-left:none;">
												</div>
											</div>
										</div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" id="furl" value="${p.url}" autocomplete="off" name="url" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control" id="fseqno" name="seqno">
